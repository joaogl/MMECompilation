    ...
    public static void ajuda(Player player, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (whatever.equalsIgnoreCase("comandos")) {
                ...
                if (player.hasPermission("mod.com")) player.sendMessage(ChatColor.GREEN + "Escreve /mod para veres os comandos de Mod.");
                if (player.hasPermission("vip.com")) player.sendMessage(ChatColor.GREEN + "Escreve /vip para veres os comandos de Vip.");
                ...
                if (player.hasPermission("adm.me")) player.sendMessage(ChatColor.GREEN + "Escreve /eco para veres os comandos de Dinheiro.");
                player.sendMessage(ChatColor.RED + "=====================================================");
                ...
                if (player.hasPermission("vip.com")) player.sendMessage(ChatColor.GREEN + "/tpahere Para teleportar alguem ate si");
