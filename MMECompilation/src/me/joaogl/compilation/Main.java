...
public class Main extends JavaPlugin {
    ...
    public static ProtectedRegion getProtectedRegion(World worldWorld, String region) {
        if (worldWorld != null) {
            ...
            if (wgPlugin != null) return wgPlugin.getRegionManager(worldWorld).getRegion(region);
    ...
    public static void addMember(ProtectedRegion protectedRegion, Player player) {
        if (protectedRegion != null && player != null) protectedRegion.getMembers().addPlayer(player.getName());

    }

    public void removeMember(ProtectedRegion protectedRegion, Player player) {
        if (protectedRegion != null && player != null) protectedRegion.getMembers().removePlayer(getWorldGuard().wrapPlayer(player));
