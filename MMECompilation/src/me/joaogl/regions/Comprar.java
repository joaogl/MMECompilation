...
public class Comprar {
    ...
    public static void ComprarPlots(Player player, String plot) {
        if (Main.econ.getBalance(player.getName()) >= PlotList.PlotPrice) {
            ...
            if (IdManager.getLang(IdManager.getId(player.getName())).equalsIgnoreCase("pt")) player.sendMessage(ChatColor.RED + "[PLOT] Nao tem dinheiro suficiente.");
            else if (IdManager.getLang(IdManager.getId(player.getName())).equalsIgnoreCase("en")) player.sendMessage(ChatColor.RED + "[PLOT] You dont have enough money.");
            else if (IdManager.getLang(IdManager.getId(player.getName())).equalsIgnoreCase("ger")) player.sendMessage(ChatColor.RED + "[Grundstuck] Sie haben nicht genug Geld.");
